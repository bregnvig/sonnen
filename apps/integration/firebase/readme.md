...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp integration-firebase` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run integration-firebase:deploy` - Deploy this app to firebase
* `nx run integration-firebase:serve` - Serve this app using the firebase emulator
* `nx run integration-firebase:build` - Build all functions associated with this app
* `nx run integration-firebase:test` - Test all functions associated with this app
* `nx run integration-firebase:lint` - Lint all functions associated with this app
